public class OperationPromotionEx {
    public static void main(String[] args) {
        ...
        char charValue1 = 'A';
        char charValue2 = 1;
        // charValue1 과 charValue2의 연산 시 두 변수의 값이 int, 타입으로 자동 타입 변환후 연산되어 그 결과가 int 타입의 데이터임
...
//        char charValue3 = charValue1 + charValue2;
        ...
        // int 타입의 데이터와 double 타입의 데이터를 연산하여 둘다 double 타입의 데이터로 변환 후 연산되어 그 결과가 double 타입임
        // 해당 double 타입의 데이터를 int 타입의 변수에 저장하려고 하기 때문에 오류가 발생함
//        int intValue6 = 510 / 4.0;
