public class CharEx {
    public static void main(String[] args) {
        ...
        // 'A' 와 "A"는 JAVA에서는 서로 다른 데이터 타입임

        char c1 = 'A'; // char 타입의 변수에 문자를 직접 입력
        char c2 = 65; // char 타입의 변수에 숫자 65를 저장
        char c3 = '\u0041'; // 유니코드표를 사용하여 0041을 저장 // u = 유니코드 표를 사용, 0x = 16진수 사용

        char c4 = '가'; // char 타입의 변수에 문자 '가' 직접 저장
